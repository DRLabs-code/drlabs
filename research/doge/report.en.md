---
title: "DOGE research note: twelfth by cap, still below the watch band on fundamentals"
description: "As of 2026-09-08, DOGE is about $0.0899 with ~$14.01B circulating mcap, rank 12. No hard cap; ~5.26B coins issued per year. Buy score 4.7/10, avoid."
date: 2026-09-09
ticker: DOGE
score: 4.7
---
...
<figure>
  <img src="../doge/scale.png" alt="DOGE circulating market cap, 24h volume and annual issuance in dollars" />
  <figcaption>Figure 1. Cap about $14.0B, 24h volume about $0.90B; annual issuance about $0.47B at spot.</figcaption>
</figure>
...
<figure>
  <img src="../doge/price-vs-ath.png" alt="DOGE spot versus the May 2021 all-time high" />
  <figcaption>Figure 2. Spot about $0.0899 versus ATH $0.7316, drawdown about 87.7%.</figcaption>
</figure>
...
<figure>
  <img src="../doge/mcap-vs-cashflow.png" alt="DOGE market cap versus UNI market cap and UNI annualized protocol revenue" />
  <figcaption>Figure 3. Narrative caps can be large. The observable protocol-revenue line belongs to UNI, not DOGE.</figcaption>
</figure>
...
| Revenue & fee capture | 15% | 2.0 | 0.30 | No protocol fees, no holder take |
| Token economics & valuation | 15% | 3.4 | 0.51 | No hard cap; ~3.4% annual inflation |
| Product & tech path | 15% | 4.0 | 0.60 | Payments work; not protocol-iteration led |
| Competitive landscape | 15% | 5.2 | 0.78 | Oldest meme brand; newer names still steal attention |
| Risk & governance | 10% | 3.6 | 0.36 | Celebrity, social media, narrative half-life |
| Growth options | 10% | 4.4 | 0.44 | Payments and attention options exist; not checkable cash flow |
| **Total** | **100%** | | **4.67** | **Avoid** |
...
1. Whether float growth stays near 3.4% annualized, or the rule changes.
2. Whether 24h volume / cap slips under 3% (liquidity thinning).
3. Whether 30-day beta versus BTC is weaker on risk-off days.
4. Listings or delistings on major payments / broker rails.
5. Any checkable burn, freeze or fee capture — not a slogan.
