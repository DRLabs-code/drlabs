---
title: "Note DOGE : 12e en capitalisation, toujours sous la bande de suivi sur les fondamentaux"
date: 2026-09-09
ticker: DOGE
score: 4.7
---
...
<figure>
  <img src="../doge/scale.png" alt="Capitalisation DOGE, volume 24 h et émission annuelle en dollars" />
  <figcaption>Figure 1. Cap ~14,0 Md$, volume 24 h ~0,90 Md$ ; émission annuelle ~0,47 Md$ au spot.</figcaption>
</figure>
...
<figure>
  <img src="../doge/price-vs-ath.png" alt="Cours DOGE versus le plus haut de mai 2021" />
  <figcaption>Figure 2. Spot ~0,0899 $ versus ATH 0,7316 $, repli ~87,7%.</figcaption>
</figure>
...
<figure>
  <img src="../doge/mcap-vs-cashflow.png" alt="Cap DOGE, cap UNI et revenu protocole annualisé UNI" />
  <figcaption>Figure 3. Les caps narratives peuvent être grandes. La ligne de revenu protocole observable appartient à UNI, pas à DOGE.</figcaption>
</figure>
...
| Revenue & fee capture | 15% | 2.0 | 0.30 | Pas de frais protocole, pas de part détenteur |
| Token economics & valuation | 15% | 3.4 | 0.51 | Pas de plafond dur ; ~3,4% d’inflation annuelle |
| Product & tech path | 15% | 4.0 | 0.60 | Les paiements marchent ; ce n’est pas l’itération protocole |
| Competitive landscape | 15% | 5.2 | 0.78 | Plus vieux mème ; de nouveaux noms volent l’attention |
| Risk & governance | 10% | 3.6 | 0.36 | Célébrité, réseaux, demi-vie narrative |
| Growth options | 10% | 4.4 | 0.44 | Options paiement et attention ; pas un flux vérifiable |
| **Total** | **100%** | | **4.67** | **Éviter** |
...
1. La croissance du float reste-t-elle près de 3,4% annualisé, ou la règle change.
2. Le volume 24 h / cap passe-t-il sous 3% (liquidité qui s’amincit).
3. Le bêta 30 jours versus BTC est-il plus faible les jours risk-off.
4. Listings ou retraits sur les grands rails paiement / courtiers.
5. Tout burn, gel ou capture de frais vérifiable — pas un slogan.
