---
title: "Nota DOGE: duodécimo por capitalización, aún bajo la banda de seguimiento en fundamentales"
date: 2026-09-09
ticker: DOGE
score: 4.7
---
...
<figure>
  <img src="../doge/scale.png" alt="Capitalización DOGE, volumen 24 h y emisión anual en dólares" />
  <figcaption>Figura 1. Cap ~14.000 M$, volumen 24 h ~900 M$; emisión anual ~470 M$ al spot.</figcaption>
</figure>
...
<figure>
  <img src="../doge/price-vs-ath.png" alt="Precio DOGE frente al máximo de mayo 2021" />
  <figcaption>Figura 2. Spot ~0,0899 $ frente a ATH 0,7316 $, caída ~87,7%.</figcaption>
</figure>
...
<figure>
  <img src="../doge/mcap-vs-cashflow.png" alt="Cap DOGE, cap UNI e ingreso de protocolo anualizado UNI" />
  <figcaption>Figura 3. Las caps narrativas pueden ser grandes. La línea de ingreso de protocolo observable es de UNI, no de DOGE.</figcaption>
</figure>
...
| Revenue & fee capture | 15% | 2.0 | 0.30 | Sin comisiones de protocolo ni parte para el tenedor |
| Token economics & valuation | 15% | 3.4 | 0.51 | Sin tope duro; ~3,4% de inflación anual |
| Product & tech path | 15% | 4.0 | 0.60 | Los pagos funcionan; no lo lidera la iteración de protocolo |
| Competitive landscape | 15% | 5.2 | 0.78 | Meme más viejo; nombres nuevos siguen robando atención |
| Risk & governance | 10% | 3.6 | 0.36 | Celebridad, redes, semivida narrativa |
| Growth options | 10% | 4.4 | 0.44 | Opciones de pagos y atención; no un flujo comprobable |
| **Total** | **100%** | | **4.67** | **Evitar** |
...
1. Si el crecimiento del float sigue cerca del 3,4% anualizado, o cambia la regla.
2. Si el volumen 24 h / cap cae bajo 3% (liquidez que se adelgaza).
3. Si el beta 30 días frente a BTC es más débil en días risk-off.
4. Altas o bajas en grandes raíles de pagos / bróker.
5. Cualquier quema, congelación o captura de comisiones comprobable — no un eslogan.
