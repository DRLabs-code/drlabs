...
Веса как на странице метода. Мемам не дают вторую таблицу. Особый режим — так смягчают стандарты.
...
Балл 4,7/10 — **субъективное** чтение открытых данных. «Избегать» не прогноз немедленного падения; «наблюдать» не повод покупать. DRLabs и автор не несут ответственности. Условия: [метод](../../method.html) и [О нас](../../about.html#disclaimer).
