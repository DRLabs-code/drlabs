---
title: "Note de recherche BNB : une étiquette de $100B que la TVL on-chain n'explique qu'en partie"
description: "Au 2026-09-08, BNB vaut environ $751 pour une mcap circulante d'environ $100B. La TVL DeFi BSC est d'environ $5.67B, troisième parmi les chaînes publiques. Score d'achat 6.6/10."
date: 2026-09-08
ticker: BNB
score: 6.6
tags:
  ...
  - BNB
  - BSC
conclusion: "BNB reste un actif très liquide du top 4. L'activité BSC et le flottant de stablecoins sont réels. La valorisation d'environ $100B reste portée par l'exchange plus le burn, pas par la TVL DeFi. Score d'achat 6.6/10, suivi prudent."
...
| Indicateur | Valeur | Source / définition |
| --- | --- | --- |
| Prix BNB | ≈ $751.3 | CoinGecko |
| Mcap circulante / FDV (offre actuelle) | ≈ $100.05B / $100.05B | Circulante ≈ totale |
| Offre circulante | ≈ 133.16M | CoinGecko |
| Plafond historique / cible de burn | 200M / 100M | Divulgations publiques |
| Distance à l'ATH | ATH $1,370 (2025-10-13), environ −45% | CoinGecko |
| TVL DeFi BSC | ≈ $5.67B | DefiLlama v2/chains |
| Stablecoins BSC | ≈ $13.29B | Stablecoins API |
| TVL bridgée | ≈ $35.25B | Page chaîne DefiLlama |
| Frais de chaîne 30j / revenus de chaîne | $18.82M / $1.88M | Fees API, category=Chain |
| Frais d'apps 30j / revenus d'apps | $79.79M / $36.37M | Fees API, apps sur BSC |
| Volume DEX 24h | ≈ $1.33B | DefiLlama dexs |
| Tx 24h / adresses actives | 18.82M / 1.84M | page chaîne |
| PancakeSwap / Lista / Venus | ≈ $2.24B / $1.32B / $1.30B | Classement protocoles BSC |
...
<figure>
  <img src="../bnb/chain-tvl-competitors.png" alt="Comparaison de TVL DeFi : Ethereum, Solana, BSC, Base, Tron, Bitcoin" />
  <figcaption>Figure 1. TVL DeFi des principales chaînes publiques. BSC ~$5.67B, troisième ; l'écart versus Solana, Base et Tron est faible.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/mcap-vs-onchain-scale.png" alt="Mcap circulante de BNB versus TVL bridgée BSC, stablecoins et TVL DeFi" />
  <figcaption>Figure 2. Capitalisation vs échelle on-chain. L'étiquette de $100B est surtout une histoire de plateforme et de burn.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/fees-vs-revenue-30d.png" alt="Frais de chaîne BSC sur 30 jours, revenus de chaîne, frais d'apps et revenus d'apps" />
  <figcaption>Figure 3. Frais et revenus sur 30 jours. Capture de chaîne ~10% ; la couche applicative est bien plus large que la chaîne elle-même.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/mcap-fdv-burn.png" alt="Mcap circulante de BNB versus valorisations au plafond de 200M et à la cible de burn de 100M" />
  <figcaption>Figure 4. Mcap circulante ~$100B ; ~$150.3B au plafond de 200M ; ~$75.1B à la cible de burn de 100M.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/bsc-protocol-tvl.png" alt="TVL de PancakeSwap, Lista, Venus et d'autres protocoles BSC" />
  <figcaption>Figure 5. TVL des principaux protocoles DeFi BSC. PancakeSwap en tête ; Lista et Venus forment un duopole de lending.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/tvl-trend.png" alt="TVL DeFi BSC sur l'année écoulée" />
  <figcaption>Figure 6. TVL DeFi BSC jusqu'au 2026-09-08, dernier point ~$5.67B ; pic d'octobre 2025 ~$9.18B.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/onchain-activity-24h.png" alt="Volume DEX 24h BSC, nombre de transactions et adresses actives" />
  <figcaption>Figure 7. Activité on-chain 24h. Débit élevé, frais par tx faibles — un trait produit de longue date chez BSC.</figcaption>
</figure>
...
| Revenus & capture de frais | 15% | 6.8 | 1.02 | Les apps sont occupées ; la chaîne conserve ~10% ; le jeton capture indirectement |
| Économie du jeton & valorisation | 15% | 5.8 | 0.87 | Le récit de burn est clair ; $100B n'est pas bon marché |
| Produit & trajectoire tech | 15% | 6.6 | 0.99 | EVM + opBNB fonctionnent ; le set de validateurs est petit |
| Paysage concurrentiel | 15% | 6.2 | 0.93 | Même bande que Solana et Base ; avance mince |
| Risque & gouvernance | 10% | 4.8 | 0.48 | Plateforme, régulation et concentration à 21 validateurs |
| Options de croissance | 10% | 6.3 | 0.63 | RWA, memes et distribution existent encore ; une partie est déjà pricée |
| **Total** | **100%** | | **6.60** | **Suivi prudent** |
...
1. Réalisations trimestrielles de l'Auto-Burn, et si l'offre totale converge vers 100 million.
2. Si la TVL DeFi BSC peut se maintenir au-dessus de $6B et creuser l'écart versus Base.
3. Frais et revenus de chaîne glissants sur 30 jours — s'agit-il seulement d'un rebond nominatif avec le prix du jeton ?
4. Parts de Pancake / Lista / Venus, plus soldes USDT/USDC sur BSC.
5. Régulation liée à l'entité Binance, concentration des wallets et changements du set de validateurs.
...
DRLabs et l'auteur ne sont pas responsables des décisions prises à partir de ce document. Faites vos propres recherches et consultez un professionnel agréé si besoin. Les conditions complètes figurent aussi sur [About DRLabs](../../about/#disclaimer).
