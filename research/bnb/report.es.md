---
title: "Nota de investigación BNB: una etiqueta de precio de $100B que el TVL on-chain solo explica en parte"
description: "Al 2026-09-08, BNB cotiza cerca de $751 con ~$100B de mcap circulante. El TVL DeFi de BSC es de unos $5.67B, tercero entre las cadenas públicas. Puntuación de compra 6.6/10."
date: 2026-09-08
ticker: BNB
score: 6.6
tags:
  ...
  - BNB
  - BSC
conclusion: "BNB sigue siendo un activo de alta liquidez entre los cuatro primeros. La actividad de BSC y el flotante de stablecoins son reales. La valoración de ~$100B sigue impulsada por el exchange más la quema, no por el TVL DeFi. Puntuación de compra 6.6/10, seguimiento cauteloso."
...
| Métrica | Valor | Fuente / definición |
| --- | --- | --- |
| Precio de BNB | ≈ $751.3 | CoinGecko |
| Mcap circulante / FDV (oferta actual) | ≈ $100.05B / $100.05B | Circulante ≈ total |
| Oferta circulante | ≈ 133.16M | CoinGecko |
| Tope histórico / objetivo de quema | 200M / 100M | Divulgaciones públicas |
| Distancia respecto al ATH | ATH $1,370 (2025-10-13), unos −45% | CoinGecko |
| TVL DeFi de BSC | ≈ $5.67B | DefiLlama v2/chains |
| Stablecoins de BSC | ≈ $13.29B | Stablecoins API |
| TVL bridged | ≈ $35.25B | Página de cadena de DefiLlama |
| Comisiones de cadena 30d / ingresos de cadena | $18.82M / $1.88M | Fees API, category=Chain |
| Comisiones de apps 30d / ingresos de apps | $79.79M / $36.37M | Fees API, apps en BSC |
| Volumen DEX 24h | ≈ $1.33B | DefiLlama dexs |
| Tx 24h / direcciones activas | 18.82M / 1.84M | página de cadena |
| PancakeSwap / Lista / Venus | ≈ $2.24B / $1.32B / $1.30B | Ranking de protocolos de BSC |
...
<figure>
  <img src="../bnb/chain-tvl-competitors.png" alt="Comparación de TVL DeFi: Ethereum, Solana, BSC, Base, Tron, Bitcoin" />
  <figcaption>Figura 1. TVL DeFi de las principales cadenas públicas. BSC ~$5.67B, tercero; la brecha frente a Solana, Base y Tron es pequeña.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/mcap-vs-onchain-scale.png" alt="Mcap circulante de BNB frente a TVL bridged, stablecoins y TVL DeFi de BSC" />
  <figcaption>Figura 2. Capitalización vs escala on-chain. La etiqueta de precio de $100B es sobre todo una historia de plataforma y quema.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/fees-vs-revenue-30d.png" alt="Comisiones de cadena, ingresos de cadena, comisiones de apps e ingresos de apps de BSC a 30 días" />
  <figcaption>Figura 3. Comisiones e ingresos a 30 días. Captura de cadena ~10%; la capa de apps es mucho mayor que la cadena misma.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/mcap-fdv-burn.png" alt="Mcap circulante de BNB frente a valoraciones con tope de 200M y objetivo de quema de 100M" />
  <figcaption>Figura 4. Mcap circulante ~$100B; ~$150.3B con tope de 200M; ~$75.1B con objetivo de quema de 100M.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/bsc-protocol-tvl.png" alt="TVL de PancakeSwap, Lista, Venus y otros protocolos de BSC" />
  <figcaption>Figura 5. TVL de los principales protocolos DeFi de BSC. PancakeSwap lidera; Lista y Venus forman un duopolio de lending.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/tvl-trend.png" alt="TVL DeFi de BSC en el último año" />
  <figcaption>Figura 6. TVL DeFi de BSC hasta 2026-09-08, último ~$5.67B; pico de octubre de 2025 ~$9.18B.</figcaption>
</figure>
...
<figure>
  <img src="../bnb/onchain-activity-24h.png" alt="Volumen DEX 24h, número de transacciones y direcciones activas de BSC" />
  <figcaption>Figura 7. Actividad on-chain 24h. Alto throughput, comisiones por tx bajas — un rasgo de producto de BSC de larga data.</figcaption>
</figure>
...
| Ingresos y captura de comisiones | 15% | 6.8 | 1.02 | Las apps están ocupadas; la cadena retiene ~10%; el token captura de forma indirecta |
| Tokenomics y valoración | 15% | 5.8 | 0.87 | La historia de quema es clara; $100B no es barato |
| Producto y ruta tecnológica | 15% | 6.6 | 0.99 | EVM + opBNB funcionan; el set de validadores es pequeño |
| Panorama competitivo | 15% | 6.2 | 0.93 | Misma banda que Solana y Base; ventaja estrecha |
| Riesgo y gobernanza | 10% | 4.8 | 0.48 | Plataforma, regulación y concentración de 21 validadores |
| Opciones de crecimiento | 10% | 6.3 | 0.63 | RWA, memes y distribución aún existen; parte ya está en el precio |
| **Total** | **100%** | | **6.60** | **Seguimiento cauteloso** |
...
1. Cifras reales del Auto-Burn trimestral, y si la oferta total converge hacia 100 million.
2. Si el TVL DeFi de BSC puede mantenerse por encima de $6B y abrirse hueco frente a Base.
3. Comisiones e ingresos de cadena rodantes a 30 días — ¿es solo un rebote nominativo con el precio de la moneda?
4. Cuota de Pancake / Lista / Venus, más saldos USDT/USDC en BSC.
5. Regulación ligada a la entidad Binance, concentración de wallets y cambios en el set de validadores.
...
DRLabs y el autor no son responsables de las decisiones tomadas con este material. Haga su propia investigación y consulte a un profesional autorizado si es necesario. Los términos completos también están en [About DRLabs](../../about/#disclaimer).
