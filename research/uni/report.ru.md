...
Веса как на странице метода. Каждый фактор 0–10, затем взвешивание до одного знака.
...
Балл 6,9/10 и веса — **субъективное** чтение открытых данных. Это не рейтинг агентства и не обещание доходности. Данные могут запаздывать, отличаться по методике или содержать ошибки. DRLabs и автор не несут ответственности. Условия: [метод](../../method.html) и [О нас](../../about.html#disclaimer).
