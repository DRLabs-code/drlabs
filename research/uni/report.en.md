---
title: "UNI research note: a thick DEX fee pool, a thin slice for the token"
description: "As of 2026-09-08, UNI is about $6.73 with ~$4.19B circulating mcap. Uniswap TVL is about $3.65B; 30-day fees about $152M and protocol revenue about $12.2M. Buy score 6.9/10."
date: 2026-09-09
ticker: UNI
score: 6.9
---
...
<figure>
  <img src="../uni/dex-tvl.png" alt="Protocol TVL for Uniswap, PancakeSwap, Curve and Raydium" />
  <figcaption>Figure 1. Major DEX protocol TVL. Uniswap about $3.65B, still first. The lead is measurable, not a slogan.</figcaption>
</figure>
...
<figure>
  <img src="../uni/fees-vs-revenue-30d.png" alt="Uniswap 30-day fees versus protocol revenue" />
  <figcaption>Figure 2. 30-day fees about $152M, protocol revenue about $12.2M, capture about 8%.</figcaption>
</figure>
...
<figure>
  <img src="../uni/chain-tvl.png" alt="Uniswap TVL on Ethereum, Base, Robinhood, Arbitrum and BSC" />
  <figcaption>Figure 3. TVL by chain. Ethereum is about two-thirds. Robinhood Chain is already in the top three.</figcaption>
</figure>
...
| Revenue & fee capture | 15% | 6.2 | 0.93 | Thick fee pool; holders keep about 8% |
| Token economics & valuation | 15% | 5.6 | 0.84 | 62% float; fee switch open; 30-day already large |
| Product & tech path | 15% | 7.4 | 1.11 | Deep V3, live V4/hooks, multi-chain |
| Competitive landscape | 15% | 6.4 | 0.96 | Lead is real; Cake / Raydium still compete |
| Risk & governance | 10% | 6.2 | 0.62 | Governance concentration, unlocks, regulation |
| Growth options | 10% | 6.8 | 0.68 | Robinhood distribution, L2s, hooks |
| **Total** | **100%** | | **6.86** | **Cautious watch** |
...
1. 30-day fees and protocol revenue — does capture leave the 8% area.
2. Public governance outcomes on the fee switch, treasury spend and unlock pace.
3. Whether Ethereum share keeps leaking to Base and other L2s.
4. Whether Robinhood Chain TVL is migrated stock or new volume.
5. 24h volume versus PancakeSwap and Raydium.
