---
title: "Nota UNI: un pozo grueso de comisiones DEX, una lonja fina para el token"
date: 2026-09-09
ticker: UNI
score: 6.9
---
...
<figure>
  <img src="../uni/dex-tvl.png" alt="TVL de protocolo de Uniswap, PancakeSwap, Curve y Raydium" />
  <figcaption>Figura 1. TVL de los principales DEX. Uniswap ~3.650 M$, sigue primero. La ventaja se mide.</figcaption>
</figure>
...
<figure>
  <img src="../uni/fees-vs-revenue-30d.png" alt="Comisiones Uniswap a 30 días frente a ingreso de protocolo" />
  <figcaption>Figura 2. Comisiones 30 días ~152 M$, ingreso de protocolo ~12,2 M$, captura ~8%.</figcaption>
</figure>
...
<figure>
  <img src="../uni/chain-tvl.png" alt="TVL de Uniswap en Ethereum, Base, Robinhood, Arbitrum y BSC" />
  <figcaption>Figura 3. TVL por cadena. Ethereum ~dos tercios. Robinhood Chain ya está en el top 3.</figcaption>
</figure>
...
| Revenue & fee capture | 15% | 6.2 | 0.93 | Pozo grueso; los tenedores se quedan ~8% |
| Token economics & valuation | 15% | 5.6 | 0.84 | 62% float; interruptor abierto; 30 días ya grandes |
| Product & tech path | 15% | 7.4 | 1.11 | V3 profundo, V4/hooks, multichain |
| Competitive landscape | 15% | 6.4 | 0.96 | Ventaja real; Cake / Raydium siguen |
| Risk & governance | 10% | 6.2 | 0.62 | Gobernanza, desbloqueos, regulación |
| Growth options | 10% | 6.8 | 0.68 | Distribución Robinhood, L2, hooks |
| **Total** | **100%** | | **6.86** | **Seguimiento cauto** |
...
1. Comisiones e ingreso de protocolo a 30 días — ¿la captura deja la zona del 8%.
2. Resultados públicos de gobernanza sobre el interruptor, tesorería y desbloqueos.
3. Si la cuota de Ethereum sigue filtrándose a Base y otros L2.
4. Si la TVL de Robinhood Chain es stock migrado o volumen nuevo.
5. Volumen 24 h frente a PancakeSwap y Raydium.
