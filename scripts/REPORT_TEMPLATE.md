...
1. 只写公开数据。记下快照时刻（UTC）和来源（CoinGecko / DefiLlama / X 公开统计 / 文档）。
1b. 必须对照全网：同行市值与成交、公链 TVL、稳定币、DEX、费用；再写推导和观点。不要只复述本币一行快照。
1c. 查 X（cashtag / 社交主导率）。有数字就写进「注意力」节；没有就标明未披露。
